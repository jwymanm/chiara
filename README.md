...
Readability means reducing the amount your brain has to process to infer meaning; getting rid of a few redundant parens may not seem like a big deal, but it can make a big difference. It also makes structural editing far easier, without having to learn / rely on tools like paredit - see [here](https://gist.github.com/one-more-minute/6088177) for examples.
